...
from flask_login import current_user, login_re
...
def account():
    ...
    return render_template('pages/account.html', selected_route=selected_route, current_user=current_user, posts=posts)