...
socket.on("post", (data) => {
    fetch("/actions/getusername", {
        method: "GET",
    }).then((res) => res.json()).thenn((data) => {
        console.log(data)
  ...
  newPost.innerHTML = `<div class="chatbox_message"><div class="chatbox_message_username">${data.author}:</div><div class="chatbox_message_text">${data.content}</div></div>`;
