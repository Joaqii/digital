...
socket.on("post", (data) => {
  ...
  newPost.innerHTML = `<div class="chatbox_message"><div class="chatbox_message_username current">${data.author}:</div><div class="chatbox_message_text">${data.content}</div></div>`;
